...
export default function UsersIndex() {
    ...
    // ✅ FIX: actualiza estado local optimistamente + refresca desde servidor
    const handleToggle = async (id: number) => {
        ...
        try {
            ...
            // Refresca para sincronizar con servidor
            const d = await adminService.getUsers({
                search: search || undefined,
                status: status || undefined,
            })
        ...
        <>
            ...
            <div className="admin-table-wrap">
                <div className="admin-table-head">
                    <h3>
                        <i className="fas fa-users" style={{ color: 'var(--paja)', marginRight: 8 }}></i>
                        Lista de Usuarios
                    </h3>
                ...
                <table>
                    ...
                    <tbody>
                        {loading ? (
                            <tr>
                                <td colSpan={7} style={{ textAlign: 'center', padding: 40, color: 'rgba(200,169,110,.4)' }}>
                            ...
                            <tr key={u.id} style={{ opacity: deletingId === u.id ? .4 : 1, transition: 'opacity .2s' }}>
                                <td>
                                    <div className="user-cell">
                                        ...
                                        <div>
                                            ...
                                            <div className="user-date">Desde {u.created_at}</div>
                                        </div>
                                    </div>
                                </td>
                                <td>{u.email}</td>
                                ...
                                <td>
                                    <div className="action-btns">
                                        ...
                                        <button
                                            className={`btn-sm ${u.is_active ? 'btn-toggle-on' : 'btn-toggle-off'}`}
