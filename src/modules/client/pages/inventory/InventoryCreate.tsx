...
const CATEGORY_OPTIONS = [
    { group: '☕ Café', items: ['Café pergamino', 'Café cereza', 'Café tostado'] },
    { group: '🥑 Aguacate', items: ['Aguacate Hass', 'Aguacate criollo'] },
    { group: '🌽 Otros Cultivos', items: ['Maíz', 'Fríjol', 'Caña', 'Plátano', 'Yuca'] },
    { group: '🧪 Insumos', items: ['Fertilizante', 'Plaguicida', 'Semillas', 'Abono orgánico'] },
    { group: '📦 Otros', items: ['Producto procesado', 'otro'] },
]
        ...
        <div className="inventory-container">
            <div className="inventory-card">
                <div className="inventory-header">
                    <i className="fas fa-boxes"></i> Registrar Inventario Agrícola
                </div>
